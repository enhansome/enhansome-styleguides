# awesome-styleguides with stars
...
* [Huge's Styleguide Tool](https://github.com/hugeinc/styleguide) ⭐ 1,852 | 🐛 16 | 🌐 JavaScript | 📅 2018-05-27 - A tool to make creating and maintaining style guides easy. Looks pretty decent, with a few uses cases and a significant following on GitHub.
...
* [Narkoz](https://github.com/narkoz/guides) ⭐ 2,421 | 🐛 3 | 📅 2025-07-02
* [SalGnt](https://github.com/SalGnt/cscs) ⭐ 1,507 | 🐛 0 | 📅 2022-10-29
...
* [rscss](https://github.com/rstacruz/rscss) ⭐ 3,906 | 🐛 30 | 📅 2023-06-07 - Reasonable Standard for CSS Stylesheet Structure.
* [CSS Best Practices](https://github.com/sezgi/CSS-Best-Practices) ⭐ 199 | 🐛 0 | 📅 2015-03-27
...
* [Airbnb](https://github.com/airbnb/javascript) ⭐ 148,140 | 🐛 161 | 🌐 JavaScript | 📅 2026-04-16
* [Mozilla/pdf.js](https://github.com/mozilla/pdf.js/wiki/Style-Guide) ⭐ 53,728 | 🐛 423 | 🌐 JavaScript | 📅 2026-08-12
...
* [johnpapa's opinionated sg for  AngularJS](https://github.com/johnpapa/angular-styleguide) ⭐ 23,624 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30
* [Todd Motto's for AngularJS](https://github.com/toddmotto/angularjs-styleguide) ⭐ 5,914 | 🐛 23 | 📅 2022-08-24
...
* [Polarmobile](https://github.com/polarmobile/coffeescript-style-guide) ⭐ 1,630 | 🐛 18 | 📅 2018-11-08

### HTTP Design

* [http-api-design](https://github.com/interagent/http-api-design) ⭐ 13,686 | 🐛 30 | 📅 2024-01-16
* [http-api-guide](https://github.com/bolasblack/http-api-guide) ⭐ 2,557 | 🐛 0 | 📅 2025-11-14 - Chinese.
...
* [mattdesl](https://github.com/mattdesl/module-best-practices) ⭐ 1,542 | 🐛 7 | 🌐 JavaScript | 📅 2018-03-30

### npm

* [npm Style Guide](https://github.com/voorhoede/npm-style-guide#readme) ⚠️ Archived - An opinionated collection of best practices for teams by [@deVoorhoede](https://twitter.com/devoorhoede).

### React

* [John Cobb](https://web-design-weekly.com/2015/01/29/opinionated-guide-react-js-best-practices-conventions/)
* [Khan](https://github.com/Khan/style-guides/blob/master/style/react.md) ⭐ 2,128 | 🐛 10 | 🌐 Shell | 📅 2024-09-06

### Riot

* [RiotJS Style Guide](https://github.com/voorhoede/riotjs-style-guide#readme) ⭐ 284 | 🐛 7 | 📅 2019-07-08 - Opinionated RiotJS Style Guide for teams by [@deVoorhoede](https://twitter.com/devoorhoede).
...
* [Swift Style Guide by @raywenderlich](https://github.com/raywenderlich/swift-style-guide) ⭐ 13,162 | 🐛 16 | 📅 2025-04-01 - The official Swift style guide for raywenderlich.com.
* [Futurice iOS Good Practices](https://github.com/futurice/ios-good-practices) ⭐ 10,974 | 🐛 22 | 📅 2024-04-30 - iOS starting guide and good practices suggestions by [@futurice](https://github.com/futurice).
...
* [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,890 | 🐛 24 | 🌐 Python | 📅 2026-08-13 - The strictest and most opinionated Python styleguide and linter ever.

## Ruby

* [bbatsov](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,553 | 🐛 74 | 📅 2026-07-20
...
* [Airbnb](https://github.com/airbnb/swift) ⭐ 2,738 | 🐛 0 | 🌐 Markdown | 📅 2026-08-06
